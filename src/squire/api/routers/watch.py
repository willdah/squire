...
async def watch_reports(
    ...
    """List reports generated by watch mode."""
...
async def watch_session_report(watch_session_id: str, watch_id: str = Query(...), db=Depends(get_db)):
    """Latest session report for a watch session."""
...
async def watch_timeline(
    ...
    """Unified watch timeline for investigation workbench."""
